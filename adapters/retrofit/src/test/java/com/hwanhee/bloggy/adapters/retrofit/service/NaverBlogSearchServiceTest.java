...
class NaverBlogSearchServiceTest {
    ...
    private @Value("${naver.api.baseurl}") String naverApiBaseUrl;
    private @Value("${naver.api.client-id}") String naverApiClientId;
    private @Value("${naver.api.client-secret}") String naverApiClientSecret;
    ...
    @BeforeEach
    void setUp() {
        sut = new NaverBlogSearchService(
                new NaverBlogSearchClient(naverApiBaseUrl, naverApiClientId, naverApiClientSecret)
        );
